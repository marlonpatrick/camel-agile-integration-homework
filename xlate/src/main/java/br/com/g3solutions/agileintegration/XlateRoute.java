...
public class XlateRoute  extends RouteBuilder {
	...
	public static final String TO_TYPE_CONVERSION_EXCEPTION_DLQ_ENDPOINT_ID = "XLATE_ROUTE_XLATE_CONVERTER_DLQ";

	public static final String TO_NEXTGATE_OUT_ENDPOINT_ID = "XLATE_ROUTE_NEXTGATE_OUT";
    ...
    public void configure() throws Exception {
    	...
    	from(FROM_ENDPOINT).routeId(ROUTE_ID)
			...
			.to("amqp:queue:xlate.converter.dlq").id(TO_TYPE_CONVERSION_EXCEPTION_DLQ_ENDPOINT_ID)
			.end()
    	.log(">>> Person XML:\n${body}")
		...
		.setExchangePattern(ExchangePattern.InOnly)
		.to("amqp:queue:nextgate.out").id(TO_NEXTGATE_OUT_ENDPOINT_ID)
    	.log(">>> DONE");
    }
}