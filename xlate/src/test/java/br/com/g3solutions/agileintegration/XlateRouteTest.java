	...
	public void testOutput() throws Exception {
		...
		camelContext.getRouteDefinition(XlateRoute.ROUTE_ID).adviceWith(camelContext, new AdviceWithRouteBuilder() {
			...
			public void configure() throws Exception {
				...
				weaveById(XlateRoute.TO_NEXTGATE_OUT_ENDPOINT_ID).replace().to("mock:nextgate.out");
			}
		});
		...
		mockNextateOut.expectedBodiesReceived(executeMatchUpdateXML("First", "Dad", "Male"));
	...
	public void testTypeConvertionErrorHandler() throws Exception {
		...
		camelContext.getRouteDefinition(XlateRoute.ROUTE_ID).adviceWith(camelContext, new AdviceWithRouteBuilder() {
			...
			public void configure() throws Exception {
				...
				weaveById(XlateRoute.TO_TYPE_CONVERSION_EXCEPTION_DLQ_ENDPOINT_ID).replace().to("mock:type-conversion-error-dlq");
			}
		});
